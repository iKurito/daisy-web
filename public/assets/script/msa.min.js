!(function (t) {
    ...
    (function () {
      function n(t) {
        ...
        return function (n, i, r, o) {
          ...
          var s = !j(n) && _.keys(n),
            ...
            l = t > 0 ? 0 : a - 1;
          return (
            arguments.length < 3 && ((r = n[s ? s[l] : l]), (l += t)),
            e(n, i, r, s, l, a)
          );
        };
      }
      function o(t) {
        return function (e, n, i) {
          n = C(n, i);
          for (var r = M(e), o = t > 0 ? 0 : r - 1; o >= 0 && r > o; o += t)
      ...
      function s(t, e, n) {
        return function (i, r, o) {
          ...
          if (r !== r)
            return (o = e(g.call(i, s, a), _.isNaN)), o >= 0 ? o + s : -1;
      ...
      function a(t, e) {
        ...
        for (_.has(t, o) && !_.contains(e, o) && e.push(o); n--; )
          (o = N[n]), o in t && t[o] !== r[o] && !_.contains(e, o) && e.push(o);
      }
      var l = this,
        h = l._,
        u = Array.prototype,
      ...
      'undefined' != typeof t && t.exports && (e = t.exports = _),
        (e._ = _),
        (_.VERSION = '1.8.3');
      ...
      (_.each = _.forEach =
        ...
        (_.find = _.detect =
          function (t, e, n) {
            var i;
            return (
              (i = j(t) ? _.findIndex(t, e, n) : _.findKey(t, e, n)),
        ...
        (_.reject = function (t, e, n) {
          return _.filter(t, _.negate(C(e)), n);
        }),
        (_.every = _.all =
          function (t, e, n) {
            e = C(e, n);
            for (
              var i = !j(t) && _.keys(t), r = (i || t).length, o = 0;
              r > o;
              o++
            ) {
              var s = i ? i[o] : o;
        ...
        (_.shuffle = function (t) {
          for (
            ...
            (e = _.random(0, o)), e !== o && (r[o] = r[e]), (r[e] = n[o]);
          return r;
        }),
        (_.sample = function (t, e, n) {
          return null == e || n
            ? (j(t) || (t = _.values(t)), t[_.random(t.length - 1)])
      ...
      (_.groupBy = L(function (t, e, n) {
        _.has(t, n) ? t[n].push(e) : (t[n] = [e]);
      })),
        (_.indexBy = L(function (t, e, n) {
          t[n] = e;
        })),
        (_.countBy = L(function (t, e, n) {
          _.has(t, n) ? t[n]++ : (t[n] = 1);
        })),
        ...
        (_.size = function (t) {
          return null == t ? 0 : j(t) ? t.length : _.keys(t).length;
        }),
      ...
      var q = function (t, e, n, i) {
        for (var r = [], o = 0, s = i || 0, a = M(t); a > s; s++) {
          var l = t[s];
          if (j(l) && (_.isArray(l) || _.isArguments(l))) {
            e || (l = q(l, e, n));
            var h = 0,
              u = l.length;
      ...
      (_.flatten = function (t, e) {
        ...
        (_.without = function (t) {
          return _.difference(t, g.call(arguments, 1));
        }),
        (_.uniq = _.unique =
          function (t, e, n, i) {
            _.isBoolean(e) || ((i = n), (n = e), (e = !1)),
              null != n && (n = C(n, i));
            for (var r = [], o = [], s = 0, a = M(t); a > s; s++) {
              var l = t[s],
                h = n ? n(l, s, t) : l;
              e
                ? ((s && o === h) || r.push(l), (o = h))
                : n
                ? _.contains(o, h) || (o.push(h), r.push(l))
                : _.contains(r, l) || r.push(l);
            }
            return r;
          }),
        (_.union = function () {
          return _.uniq(q(arguments, !0, !0));
        }),
        (_.intersection = function (t) {
          for (var e = [], n = arguments.length, i = 0, r = M(t); r > i; i++) {
            var o = t[i];
            if (!_.contains(e, o)) {
        ...
        (_.unzip = function (t) {
          for (
            var e = (t && _.max(t, M).length) || 0, n = Array(e), i = 0;
            e > i;
            i++
          )
            n[i] = _.pluck(t, i);
      ...
      (_.bind = function (t, e) {
        if (x && t.bind === x) return x.apply(t, g.call(arguments, 1));
        if (!_.isFunction(t))
          throw new TypeError('Bind must be called on a function');
        var n = g.call(arguments, 2),
          i = function () {
            return R(t, i, e, this, n.concat(g.call(arguments)));
          };
        return i;
      }),
            ...
            return (
              ...
              0 >= u || u > e
                ? (s && (clearTimeout(s), (s = null)),
                  ...
                  (o = t.apply(i, r)),
                  s || (i = r = null))
                : s || n.trailing === !1 || (s = setTimeout(l, u)),
              o
            );
          };
        }),
        ...
        (_.before = function (t, e) {
          ...
          return function () {
            return (
              --t > 0 && (n = e.apply(this, arguments)), 1 >= t && (e = null), n
            );
          };
        }),
      ...
      (_.keys = function (t) {
        ...
        (_.values = function (t) {
          for (var e = _.keys(t), n = e.length, i = Array(n), r = 0; n > r; r++)
            i[r] = t[e[r]];
          return i;
        }),
        (_.mapObject = function (t, e, n) {
          e = C(e, n);
          for (var i, r = _.keys(t), o = r.length, s = {}, a = 0; o > a; a++)
            (i = r[a]), (s[i] = e(t[i], i, t));
          return s;
        }),
        (_.pairs = function (t) {
        ...
        (_.invert = function (t) {
          for (var e = {}, n = _.keys(t), i = 0, r = n.length; r > i; i++)
            e[t[n[i]]] = n[i];
          return e;
        }),
        ...
        (_.extend = k(_.allKeys)),
        (_.extendOwn = _.assign = k(_.keys)),
        ...
        (_.omit = function (t, e, n) {
          if (_.isFunction(e)) e = _.negate(e);
            ...
            var i = _.map(q(arguments, !1, !1, 1), String);
            e = function (t, e) {
      ...
      var O = function (t, e, n, i) {
        ...
        if ((n.push(t), i.push(e), o)) {
          ...
          for (; l--; ) if (!O(t[l], e[l], n, i)) return !1;
        } else {
          var h,
            u = _.keys(t);
          if (((l = u.length), _.keys(e).length !== l)) return !1;
          for (; l--; )
            if (((h = u[l]), !_.has(e, h) || !O(t[h], e[h], n, i))) return !1;
        }
      ...
      (_.isEqual = function (t, e) {
        ...
        (_.isEmpty = function (t) {
          return null == t
            ? !0
            : j(t) && (_.isArray(t) || _.isString(t) || _.isArguments(t))
            ? 0 === t.length
            : 0 === _.keys(t).length;
        }),
      ...
      (_.mixin = function (t) {
        _.each(_.functions(t), function (e) {
          ...
          _.prototype[e] = function () {
            var t = [this._wrapped];
            return f.apply(t, arguments), U(this, n.apply(_, t));
          };
        });
      }),
        _.mixin(_),
  ...
  function (t, e, n) {
    (t.exports.Model = n(44)),
      (t.exports.Collection = n(92)),
      (t.exports.Events = n(11)),
      (t.exports.extend = n(17));
  },
  function (t, e, n) {
    var i = n(1),
      r = n(11),
  ...
  function (t, e, n) {
    ...
    t.exports = i = r.extend({
      ...
      buildNode: function (t) {
        return null != this.g
          ? (t.style.lineHeight = this.g.menuconfig.get('menuItemLineHeight'))
          : void 0;
      },
      ...
      buildMenu: function (t) {
        return null != this.g
          ? (t.style.fontSize = this.g.menuconfig.get('menuItemFontsize'))
          : void 0;
      },
    });
  },
    ...
    t.exports = r = s.extend({
      renderSubviews: function () {
        ...
        for (
          ...
          (r = u[c]), r.render(), (s = r.el), null != s && l.appendChild(s);
        return t.appendChild(l), e && n(), t;
      },
      ...
      !(function (r) {
        function o(t) {
          ...
          return b(n) || t === r
            ...
            : 1 === t.nodeType && e
            ? !0
            : x(n) || 0 === e || ('number' == typeof e && e > 0 && e - 1 in t);
        }
        function s(t, e) {
          var n, i;
          ...
          for (n in t)
            (t[n] || 'function' == typeof t[n]) && i.call(this, n, t);
          y.extend(this, e, {
        ...
        (y.noConflict = function () {
                ...
                init: function (t, e) {
                  ...
                  if (m(t)) {
                    ...
                    if ((i = c.exec(t)) && i[1]) {
                      ...
                      return (n = d.call(o.childNodes)), y.merge(this, n);
                    }
                    if (y.isElement(e)) return y(e).find(t);
                    try {
                      return (n = p.querySelectorAll(t)), y.merge(this, n);
                    } catch (s) {
                      return this;
                    }
                  }
          ...
          (y.setId = function (t) {
            ...
            t === r
              ? (e = 'window')
              : void 0 === t.jid && (t.jid = e = ++y._cache.jid),
              y._cache.events[e] || (y._cache.events[e] = {});
          }),
          (y.getData = function (t) {
            t = t instanceof y ? t[0] : t;
            var e = t === r ? 'window' : t.jid;
            return { jid: e, events: y._cache.events[e] };
          }),
          (y.isElement = function (t) {
            return (t && t instanceof y) || t instanceof HTMLElement || m(t);
          }),
          (y._cache = { events: {}, jid: 0 }),
          (a.pushStack = function (t) {
            var e = y.merge(this.constructor(), t);
            return e;
          }),
          (y.merge = function (t, e) {
            for (var n = e.length, i = t.length, r = 0; n > r; )
              t[i++] = e[r++];
            return (t.length = i), t;
          }),
          ...
          (y.extend = function (t) {
            var e;
            return (
              f.call(arguments, 1).forEach(function (n) {
                if (((e = t), n)) for (var i in n) e[i] = n[i];
              }),
              t
            );
          }),
          (y.makeArray = function (t, e) {
            var n = e || [];
            return (
              null !== t && (o(t) ? y.merge(n, m(t) ? [t] : t) : n.push(t)), n
            );
          }),
          (y.unique = function (t) {
            if (null == t) return [];
          ...
          (y.event = {
            add: function (t, e, n, i, r) {
              ...
              var o,
                ...
                a,
                l = function (e) {
                  y.event.dispatch.call(t, e);
                },
                h = y.getData(t).events;
              for (e = e.split(' '), s = e.length; s--; )
                (a = e[s]),
                  ...
                  h[o].length
                    ? (l = h[o][0].fn)
                    : t.addEventListener && t.addEventListener(o, l, !1),
                  h[o].push({
              ...
              var i,
                ...
                o = function (t, e, i, r, o) {
                  ...
                  ((n && o.originfn === n) || !n) && (s = o.fn),
                    t[e][i].fn === s &&
                      (t[e].splice(i, 1),
                      t[e].length || r.removeEventListener(e, s));
                },
                s = y.getData(t).events;
              if (s)
                return !e && s
                  ? g(s).forEach(function (e) {
                      for (r = s[e], i = r.length; i--; ) o(s, e, i, t, r[i]);
                    })
            ...
            trigger: function (t, e) {
              ...
              m(e)
                ...
                : ((e = e instanceof Event ? e : y.Event(e)), (n = [e])),
            ...
            dispatch: function (t) {
              ...
              for (
                ...
                c > a &&
                ~u.indexOf(d[a]) &&
                (!r || !r.isImmediatePropagationStopped());
                a++
              )
                if (
                  ((n = null),
                  (o = {}),
                  (i = d[a]),
                  i.data && (o.data = i.data),
                  i.selector)
                ) {
                  if (
                    (~(f = y(h).find(i.selector)).indexOf(t.target) &&
                      (n = t.target)) ||
                    (h !== t.target && h.contains(t.target))
                  ) {
                    if (!n)
                      for (e = f.length, l = 0; e > l; l++)
                        f[l] && f[l].contains(t.target) && (n = f[l]);
                    if (!n) continue;
                    (o.currentTarget = n),
                      (r = new s(t, o)),
                      (t.namespace && t.namespace !== i.namespace) ||
                        i.originfn.call(n, r);
                  }
                } else
                  (r = new s(t, o)),
          ...
          (a.on = function (t, e, n, i) {
            ...
            if (
              ...
              return this;
            for (; r > o; o++) y.event.add(this[o], t, i, n, e);
            return this;
          }),
          (a.one = function (t) {
            var e,
          ...
          (a.trigger = function (t) {
            var e = 0,
              n = this.length;
            if (!t) return this;
            for (; n > e; e++) y.event.trigger(this[e], t);
            return this;
          }),
          (a.off = function (t, e) {
          ...
          (a.css = function (t, e) {
            var n,
              ...
              s = this.length;
            if (m(t) && 1 === i.length)
              return this[0] && r.getComputedStyle(this[0])[t];
            for (
              2 === i.length
                ? (n = function (n) {
                    n.style[t] = e;
          ...
          (a.data = function (t, e) {
            ...
            if (0 === i.length)
              return (
                this[0].jdata && (r = this[0].jdata),
                g(this[0].dataset).forEach(function (t) {
                  r[t] = l(this[0].dataset[t]);
                }, this),
                r
              );
            if (1 === i.length && m(t))
              return (
                this[0] &&
                l(this[0].dataset[t] || (this[0].jdata && this[0].jdata[t]))
              );
            for (
              1 === i.length && v(t)
                ? (n = function (e) {
          ...
          (a.removeData = function (t) {
            for (var e, n, i = 0, r = this.length; r > i; i++)
              if (((e = this[i].jdata), (n = this[i].dataset), t))
          ...
          (a.addClass = function (t) {
            for (
              ...
              for (n = 0, n = 0; n < r.length; n++) this[e].classList.add(r[n]);
            return this;
          }),
          (a.removeClass = function (t) {
            for (
              ...
              for (n = 0, n = 0; n < r.length; n++)
                this[e].classList.remove(r[n]);
            return this;
          }),
          (a.toggleClass = function (t, e) {
            var n = 0,
              i = this.length,
              r = 'toggle';
            if (((e === !0 && (r = 'add')) || (e === !1 && (r = 'remove')), t))
              for (; i > n; n++) this[n].classList[r](t);
            return this;
          }),
          (a.hasClass = function (t) {
            var e = 0,
              n = this.length;
            if (t)
              for (; n > e; e++) if (this[e].classList.contains(t)) return !0;
            return !1;
          }),
          (a.html = function (t) {
            var e,
          ...
          (a.append = function (t) {
            ...
            for (
              m(t) && c.exec(t)
                ? (t = y(t))
                : v(t) || (t = document.createTextNode(t)),
                t = t instanceof y ? t : y(t),
                e = function (e, n) {
  ...
  function (t, e, n) {
    ...
    var i = n(1),
      r = n(2).Model,
      o = r.extend({ defaults: { type: 'super' } }),
      s = o.extend({
        defaults: i.extend({}, o.prototype.defaults, {
          type: 'row',
          seqId: '',
        }),
        inRow: function (t) {
      ...
      l = s.extend(
        i.extend({}, i.pick(a, 'inColumn'), i.pick(a, 'getLength'), {
          defaults: i.extend({}, a.prototype.defaults, s.prototype.defaults, {
            type: 'pos',
          }),
        })
      );
  ...
  function (t, e, n) {
    ...
    t.exports = i = s.extend({
      ...
      resetJSON: function (t) {
        return (t = o.map(t, this._fromJSON)), this.reset(t);
      },
      getBlocksForRow: function (t, e) {
        for (
          var n,
            i = this.filter(function (e) {
              return e.inRow(t);
            }),
            r = [],
            o = 0;
          ...
          if (((n = i[o]), 'row' === n.attributes.type)) {
            r = (function () {
              var t = [],
                n = 0;
              if (e >= 0) for (; e >= n; ) t.push(n++);
      ...
      getAllColumnBlocks: function (t) {
        ...
        if (t.withPos)
          var n = this.filter(function (t) {
            return null != t.get('xStart');
          });
        else
          n = this.filter(function (t) {
        ...
        for (var i, r = 0; r < n.length; r++)
          (i = n[r]),
            (e = e.concat(
              (function () {
                var t = [],
                  e = i.attributes.xStart;
                if (i.attributes.xStart <= i.attributes.xEnd)
                  for (; e <= i.attributes.xEnd; ) t.push(e++);
                else for (; e >= i.attributes.xEnd; ) t.push(e--);
                return t;
              })()
            ));
        return (e = o.uniq(e));
      ...
      invertRow: function (t) {
        ...
        for (
          var n,
            i = o.filter(t, function (t) {
              return e.indexOf(t) >= 0 ? !1 : !0;
            }),
            s = [],
            a = 0;
          a < i.length;
          ...
          (n = i[a]), s.push(new r.rowsel({ seqId: n }));
        return this.reset(s);
      },
      invertCol: function (t) {
        var e,
          n = this.where({ type: 'column' });
        n = o.reduce(
          n,
          function (t, e) {
            return t.concat(
        ...
        var i = o.filter(t, function (t) {
          return n.indexOf(t) >= 0 ? !1 : !0;
        });
        if (0 !== i.length) {
          for (var s, a = [], l = (e = i[0]), h = 0; h < i.length; h++)
            (s = i[h]),
              e + 1 === s
                ? (e = s)
                : (a.push(new r.columnsel({ xStart: l, xEnd: e })),
                  (l = e = s));
          return (
            l !== e &&
              a.push(new r.columnsel({ xStart: l, xEnd: i[i.length - 1] })),
            this.reset(a)
          );
        }
      },
      ...
      _reduceColumns: function () {
        return this.each(function (t, e, n) {
          for (
            var i,
              r = o.filter(n, function (t) {
                return 'column' === t.get('type');
              }),
              s = t.get('xStart'),
              a = t.get('xEnd'),
              l = o.filter(r, function (t) {
                return t.get('xEnd') === s - 1;
              }),
              h = 0;
            h < l.length;
            h++
          ...
          for (
            var u,
              c = o.filter(r, function (t) {
                return t.get('xStart') === a + 1;
              }),
              d = 0;
            d < c.length;
            d++
          )
            (u = c[d]), u.set('xStart', a);
          return l.length > 0 || c.length > 0
            ? (console.log('removed el'), t.collection.remove(t))
            : void 0;
        });
      },
    });
  ...
  function (t, e) {
    ...
    var n = 'http://www.w3.org/2000/svg',
      ...
      s = function (t) {
        var e = document.createElementNS(n, 'line');
        return i(e, t);
      },
      a = function (t) {
        var e = document.createElementNS(n, 'polygon');
        return i(e, t);
      };
    (t.exports.rect = o),
      (t.exports.line = s),
  ...
  function (t, e, n) {
    ...
    t.exports = i = {
      openInJalview: function (t, e) {
        ...
        var i = 'http://www.jalview.org/services/launchApp?open=' + t;
        return (i += '&colour=' + e), window.open(i, '_blank');
      },
      publishWeb: function (t, e) {
        var n = r.write(t.seqs.toJSON());
        n = encodeURIComponent(n);
        var i = 'http://sprunge.biojs.net';
        return s(
          {
            method: 'POST',
            body: 'sprunge=' + n,
      ...
      saveSelection: function (t, e) {
        ...
        if ((console.log(n), n.length > 0)) {
          n = t.seqs.filter(function (t) {
            return h.contains(n, t.get('id'));
          });
          for (
      ...
      saveAnnots: function (t, e) {
        ...
        (n = h.flatten(h.compact(n))), console.log(n);
        var i = o.exportLines(n),
          r = new Blob([i], { type: 'text/plain' });
        return l(r, e);
      },
  ...
  function (t, e, n) {
    ...
    var u = {
      ...
      guessFileFromText: function (t) {
        if ('undefined' == typeof t || null === t)
          return console.warn('invalid file format'), ['', 'error'];
        if ('CLUSTAL' === t.substring(0, 7))
          var e = s,
            n = 'seqs';
        else
          '>' === t.substring(0, 1)
      ...
      parseText: function (t) {
        var e = this.guessFileFromText(t),
          n = r(e, 2),
          i = n[0],
          o = n[1];
        if ('seqs' === o) {
      ...
      importFile: function (t) {
        ...
        return 'error' === a
          ? 'error'
          : ('seqs' === a
              ? (this.msa.seqs.reset(s),
                this.msa.g.config.set('url', 'userimport'),
                this.msa.g.trigger('url:userImport'))
              : 'features' === a
              ? this.msa.seqs.addFeatures(s)
              : 'newick' === a &&
      ...
      importURL: function (t, e) {
        ...
        return (
          ...
          h(t, function (i, r, o) {
            ...
            var s = n.importFile(o);
            if ('error' !== s)
              return n.msa.g.trigger('import:url', t), e ? e() : void 0;
          })
        );
      },
    };
    l.extend(i.prototype, u);
  },
  function (t, e, n) {
    'use strict';
    var i,
    ...
    t.exports = i = {
      loadScript: function (t, e) {
        ...
        return i.parentNode.appendChild(n);
      },
              ...
              (r = t[l]),
                '>' === r[0] || ';' === r[0]
                  ? ((i = r.slice(1)),
                    (s = o.getMeta(i)),
                    (i = s.name),
                    (e = new o.model('', i, a.length)),
                    (e.ids = s.ids || {}),
                    (n = Object.keys(e.ids)),
                    n.length > 0 && (e.id = e.ids[n[0]]),
                    (e.details = s.details || {}),
                    a.push(e))
                  : (e.seq += r);
            return a;
  ...
  function (t, e, n) {
    function i(t, e) {
      ...
      function i() {
        ...
        if (
          (p.response
            ? (t = p.response)
            : ('text' !== p.responseType && p.responseType) ||
              (t = p.responseText || p.responseXML),
          _)
        )
          try {
            t = JSON.parse(t);
      ...
      function c(t, e) {
        var n = null;
        if (0 === t || (t >= 400 && 600 > t)) {
          var i = ('string' == typeof e ? e : !1) || l[String(t).charAt(0)];
          (n = new Error(i)), (n.statusCode = t);
        }
        return n;
      }
      function d() {
        var t = o(),
          n = i(),
          r = c(t, n),
          s = { body: n, statusCode: t, statusText: p.statusText, raw: p };
        p.getAllResponseHeaders
          ? (s.headers = a(p.getAllResponseHeaders()))
          : (s.headers = {}),
          e(r, s, s.body);
      }
      function f() {
      ...
      'string' == typeof t && (t = { uri: t }), (t = t || {}), (e = s(e));
      var p = t.xhr || null;
      p || (p = t.cors || t.useXDR ? new u() : new h());
      var m,
        v = (p.url = t.uri || t.url),
        b = (p.method = t.method || 'GET'),
        x = t.body || t.data,
        y = (p.headers = t.headers || {}),
        w = !!t.sync,
        _ = !1,
        S = t.response ? d : f;
      if (
        ('json' in t &&
          ...
          'GET' !== b &&
            ...
            (x = JSON.stringify(t.json)))),
        (p.onreadystatechange = n),
        (p.onload = S),
        (p.onerror = g),
        (p.onprogress = function () {}),
        (p.ontimeout = r),
        p.open(b, v, !w),
        (t.withCredentials || (t.cors && t.withCredentials !== !1)) &&
          (p.withCredentials = !0),
        w || (p.timeout = 'timeout' in t ? t.timeout : 5e3),
        p.setRequestHeader)
      )
        for (m in y) y.hasOwnProperty(m) && p.setRequestHeader(m, y[m]);
      else if (t.headers)
        throw new Error('Headers cannot be set on an XDomainRequest object');
      return (
        'responseType' in t && (p.responseType = t.responseType),
        'beforeSend' in t &&
    ...
    var o = n(50),
      ...
      h = o.XMLHttpRequest || r,
      u = 'withCredentials' in new h() ? h : o.XDomainRequest;
    t.exports = i;
  },
  function (t, e, n) {
    'use strict';
  ...
  function (t, e, n) {
    ...
    t.exports = i = r.extend({
      ...
      calcHiddenColumns: function (t) {
        for (var e, n = this.get('hidden'), i = t, r = 0; r < n.length; r++)
          (e = n[r]), i >= e && i++;
        return i - t;
      },
    });
    ...
    t.exports = i = o.extend({
      ...
      loadPackage: function (t, e) {
        try {
          ...
          return r.loadScript(this._pkgURL(t), e);
        }
      },
  ...
  function (t, e, n) {
    ...
    var i,
      r = n(2).Model;
    t.exports = i = r.extend({ defaults: { searchText: '' } });
  },
  function (t, e, n) {
    'use strict';
    var i,
  ...
  function (t, e, n) {
    ...
    t.exports = i = r.extend({
      ...
      constructor: function (t, e) {
        return this.calcDefaults(e.model), r.apply(this, arguments);
      },
      initialize: function () {
        return (
          this.listenTo(
  ...
  function (t, e, n) {
    ...
    t.exports = i = r.extend({
      ...
      calcDefaults: function (t) {
        var e = t.getMaxLength();
        return 200 > e && t.length < 30
      ...
      setTopOffset: function (t) {
        for (
          var e = Math.max(0, t - 1), n = 0, i = 0;
          e > 0 ? e >= i : i >= e;
          e > 0 ? i++ : i++
        ) {
          var r = this.model.at(i);
          n += r.attributes.height || 1;
        }
      ...
      _adjustWidth: function () {
        if (void 0 !== this.el && void 0 !== this.model) {
          ...
          return (
            (i =
              Math.floor(i / this.get('columnWidth')) *
              this.get('columnWidth')),
            (this.attributes.alignmentWidth = i)
          );
        }
      },
      autoResize: function () {
        return this.get('autoResize')
          ? this._adjustWidth(this.el, this.model)
          : void 0;
      },
      ...
      _checkScrolling: function (t, e) {
        ...
        return (
          ...
          this.set('_alignmentScrollTop', i, e)
        );
      },
    ...
    t.exports = i = r.extend({
      ...
      initialize: function (t) {
        return (
          ...
          _.isNumber(this.attributes.xStart) && _.isNumber(this.attributes.xEnd)
            ? void 0
      ...
      validate: function () {
        return isNaN(this.attributes.xStart || isNaN(this.attributes.xEnd))
    ...
    t.exports = i = o.extend({
      ...
      assignRows: function () {
        var t = this.max(function (t) {
          ...
          e = (function () {
            for (var e = [], n = 0; t > 0 ? t >= n : n >= t; t > 0 ? n++ : n--)
              e.push(0);
            return e;
          })();
        return (
          this.each(function (t) {
            for (
              var n = 0, i = t.get('xStart'), r = t.get('xEnd'), o = i;
              r > i ? r >= o : o >= r;
              r > i ? o++ : o++
            )
              e[o] > n && (n = e[o]), e[o]++;
      ...
      getMinRows: function () {
        ...
        return (
          this.each(function (t) {
            return (function () {
              for (
                var n = [], i = t.get('xStart'), r = t.get('xEnd'), o = i;
                r > i ? r >= o : o >= r;
                r > i ? o++ : o++
              )
                n.push(e[o]++);
  ...
  function (t, e, n) {
    ...
    t.exports = i = s.extend({
      ...
      prev: function (t, e) {
        ...
        return 0 > n && e && (n = this.length - 1), this.at(n);
      },
      next: function (t, e) {
        var n = this.indexOf(t) + 1;
      ...
      calcHiddenSeqs: function (t) {
        for (var e = t, n = 0; e > 0 ? e >= n : n >= e; e > 0 ? n++ : n--)
      ...
      addFeatures: function (t) {
        ...
        if (null != t.config) {
          ...
          if (((t = t.seqs), null != n.config.colors)) {
            var i = n.config.colors;
            _.each(t, function (t) {
              return _.each(t, function (t) {
                return null != i[t.feature]
      ...
      _bindSeqWithFeatures: function (t) {
        ...
        return e
          ? (t.set('features', new o(e)),
            t.attributes.features.assignRows(),
            t.set('height', t.attributes.features.getCurrentHeight() + 1))
          : void 0;
      },
      ...
      _autoSetRefSeq: function () {
        return this.length > 0 ? this.at(0).set('ref', !0) : void 0;
      },
      setRef: function (t) {
        var e = this.get(t);
        return (
  ...
  function (t, e, n) {
    ...
    t.exports = i = r.extend({
      ...
      initialize: function () {
        return (
          this.set('grey', []),
          null == this.get('features') ? this.set('features', new o()) : void 0
        );
      },
    });
  },
  function (t, e, n) {
    'use strict';
    (t.exports.bmath = n(12)),
      (t.exports.proxy = n(16)),
      (t.exports.seqgen = n(35)),
      (t.exports.file = n(14)),
      (t.exports['export'] = n(13));
  },
  function (t, e, n) {
    'use strict';
    var i = n(95).seq,
      ...
      s = (t.exports = {
        ...
        getDummySequences: function (t, e) {
          var n = [];
          ('undefined' == typeof t || null === t) && (t = r.getRandomInt(3, 5)),
            ('undefined' == typeof e || null === e) &&
              (e = r.getRandomInt(50, 200));
          for (var o = 1; t > 1 ? t >= o : o >= t; t > 1 ? o++ : o++)
            n.push(new i(s._generateSequence(e), 'seq' + o, 'r' + o));
          return n;
        },
        ...
        genConservedSequences: function (t, e, n) {
          ...
          for (var l = 1; t > 1 ? t >= l : l >= t; t > 1 ? l++ : l++)
            a[l - 1] = '';
          for (
            var h = 0.2, u = 1, c = e - 1, l = 0;
            c > 0 ? c >= l : l >= c;
            c > 0 ? l++ : l++
          ) {
            l % 3 === 0 && (u = r.getRandomInt(50, 100) / 100);
            for (
              var d = [], f = t - 1, g = 0;
              f > 0 ? f >= g : g >= f;
              f > 0 ? g++ : g++
              ...
              for (var p = 0; 100 > p; ) {
                var m = s.getRandomChar(n),
                  v = o(d);
                if (
                  (v.addSeq(m),
                  p++,
                  Math.abs(u - v.scale(v.conservation())[0]) < h)
                )
                  break;
              }
              (a[g] += m), d.push(m);
          ...
          for (var b = [], l = 1; t > 1 ? t >= l : l >= t; t > 1 ? l++ : l++)
            b.push(new i(a[l - 1], 'seq' + l, 'r' + l));
          return b;
        },
      });
  },
  function (t, e, n) {
    ...
    var o = {
      ...
      showTree: function (t) {
        var e = this.require('biojs-io-newick');
        if ('string' == typeof t) var i = e.parse_newick(t);
        else i = t;
        var o = this.require('msa-tnt'),
          s = new o.selections(),
          a = document.createElement('div');
        this.msa.el.appendChild(a),
          console.log(this.msa.seqs.models),
          console.log(i);
        var l = o.app({ seqs: this.msa.seqs.toJSON(), tree: i });
        console.log('nodes', l);
        new o.adapters.tree({ model: l, el: a, sel: s }),
          new o.adapters.msa({ model: l, sel: s, msa: this.msa });
        return (
          r.each(l.models, function (t) {
            return (
              delete t.collection,
              Object.setPrototypeOf(t, n(2).Model.prototype)
            );
          }),
  ...
  function (t, e, n) {
    ...
    (r.parseLines = function (t) {
      ...
      var o = 0;
      if ('jalview' === n.type) {
        var a = s.readHeader(e);
        (o = a.offset), (n.colors = a.colors), (i = a.features);
      }
      for (var l = o; l < e.length; l++) {
        var h = e[l];
        0 !== h.length &&
          '#' !== h[0] &&
          ((h = r.parseLine(h)), void 0 !== h && i.push(h));
      }
      return { features: i, config: n };
    }),
      (r._guessType = function (t) {
      ...
      (r.parseLine = function (t) {
        ...
        if (1 !== n.length) {
          ...
          return (
            ...
            (e.attributes = o.extractKeys(i)),
            e
          );
        }
      }),
      (r.exportLine = function (t) {
      ...
      (r.exportLines = function (t) {
        return '##gff-version 3\n' + t.map(r.exportLine).join('\n');
      }),
      (r.exportSeqs = r['export'] =
        function (t) {
          var e = [],
            n = function (t) {
              (t.seqname = i), e.push(t);
            };
          for (var i in t) t[i].forEach(n);
          return r.exportLines(e);
        });
  },
  function (t, e, n) {
    var i,
    ...
    t.exports = i = (function () {
      ...
      return (
        ...
        (t._onRetrieval = function (t, e, n, i) {
          var r;
          return 'undefined' != typeof t && (r = i.parse(e)), n.call(i, t, r);
        }),
  ...
  function (t, e) {
    ...
    (t.exports = n),
      (n.getMeta = function (t) {
        if (n.contains(t, '|')) {
          for (var e, o, s = t.split('|'), a = 0, l = {}; a < s.length - 1; )
            (e = s[a]), (o = s[a + 1]), (l[e] = o), (a += 2);
          var h = s[s.length - 1];
          if (h.indexOf('=') >= 0 && h.indexOf('OS') >= 0) {
            var u = {},
              c = h.split(' ');
            (u.en = c[0]), (c = c.splice(1));
            var d = i(c, '='),
              f = c.splice(d - 1);
            (h = c.join(' ')), (c = f), (a = 0);
            var g = [];
            return (
              c.forEach(function (t) {
                g.push(t),
                  t.indexOf('=') >= 0 && (r(g.join(' '), '=', u), (g = []));
              }),
              { name: h, ids: l, details: u }
            );
          }
          return { name: h, ids: l };
        }
    ...
    var i = function (t, e) {
        for (var n = 0; n < t.lenght; n++) if (t[n].indexOf(n)) return n;
        return t.length - 1;
      },
      r = function (t, e, n) {
        n = n || {};
        var i = t.split(e);
        return (n[i[0].toLowerCase()] = i[1]), n;
      },
      o = {
  ...
  function (t, e, n) {
    ...
    }).call(e, n(40).setImmediate, n(40).clearImmediate);
  },
  function (t, e) {
  ...
  function (t, e, n) {
    'use strict';
    t.exports.SelectionManager = n(9);
  },
  function (t, e, n) {
    'use strict';
    (t.exports.seq = n(33)),
      (t.exports.seqcol = n(32)),
      (t.exports.feature = n(30)),
      (t.exports.featurecol = n(31));
  },
  function (t, e, n) {
    var i = n(11),
      r = n(17),
    ...
    o.extend(s.prototype, i, {
      ...
      set: function (t, e, n) {
        ...
        for (i in r)
          (e = r[i]),
            o.isEqual(c[i], e) || a.push(i),
            o.isEqual(u[i], e) ? delete this.changed[i] : (this.changed[i] = e),
            s ? delete c[i] : (c[i] = e);
        if (!l) {
          a.length && (this._pending = n);
          for (var d = 0, f = a.length; f > d; d++)
            this.trigger('change:' + a[d], this, c[a[d]], n);
        }
        if (h) return this;
        if (!l)
          for (; this._pending; )
      ...
      save: function (t, e, n) {
        ...
        return (
          (n.success = function (t) {
            ...
            var e = l.parse(t, n);
            return (
              n.wait && (e = o.extend(i || {}, e)),
              o.isObject(e) && !l.set(e, n)
                ? !1
                : (h && h(l, t, n), void l.trigger('sync', l, t, n))
            );
          }),
          wrapError(this, n),
          (r = this.isNew() ? 'create' : n.patch ? 'patch' : 'update'),
          'patch' !== r || n.attrs || (n.attrs = i),
      ...
      url: function () {
        var t =
          o.result(this, 'urlRoot') ||
          o.result(this.collection, 'url') ||
          urlError();
        return this.isNew()
          ? t
      ...
      (t.exports = i =
        {
          parse: function (t) {
            ...
            for (i = 0, e = 1, d = 0; i < l.length; )
              i++,
                (a = l[i]),
                null != a && 0 !== a.length && 0 !== a.trim().length
                  ? o.contains(a, '*') ||
                    (1 === e && ((d = 0), (e = 0)),
                    (c = /^(?:\s*)(\S+)(?:\s+)(\S+)(?:\s*)(\d*)(?:\s*|$)/g),
                    (h = c.exec(a)),
                      ...
                      ? ((s = h[1]),
                        ...
                        d >= f.length
                          ? ((u = o.getMeta(s)),
                            ...
                            (n.details = u.details || {}),
                            (r = Object.keys(n.ids)),
                            r.length > 0 && (n.id = n.ids[r[0]]),
                            f.push(n))
                          : (f[d].seq += g),
                        d++)
                      : console.log('parse error', a))
                  : (e = 1);
            return f;
          },
        }),
  ...
  function (t, e) {
    ...
    (t.exports = i),
      ...
      (i.rgbToHex = function (t, e, r) {
        return 3 === t.length
          ? i.rgbToHex(t[0], t[1], t[2])
          : '#' + n(t) + n(e) + n(r);
      });
  },
  function (t, e) {
    ...
    t.exports = n = {
      rel: function (t) {
        ...
        return (
          ...
          void 0 == e && ((e = t.clientX - i.left), (n = t.clientY - i.top)),
          void 0 == e &&
            ((e = t.pageX - r.offsetLeft), (n = t.pageY - r.offsetTop)),
          void 0 == e)
  ...
  function (t, e, n) {
    ...
    (r.prototype.addSeq = function (t) {
      this.seqs.push(t), this._reset();
    }),
      (r.prototype.removeSeq = function (t) {
        'number' == typeof t
      ...
      (r.prototype.addSeqs = function (t) {
        t.forEach(
          function (t) {
            this.addSeq(t);
          }.bind(this)
      ...
      (r.prototype.resetSeqs = function (t) {
    ...
    (r.prototype._reset = function () {
      ...
      (r.prototype.useBackground = function () {
        this.setBackground(!0);
      }),
      (r.prototype.setDNA = function () {
        this.alphabetSize = 4;
      }),
      (r.prototype.setProtein = function () {
      ...
      (r.prototype.identity = function (t) {
        var e;
        return (
      ...
      (r.prototype.backgroundCalc = function () {
        var t = {},
          e = 0;
        return (
          i.each(this.seqs, function (n) {
            i.each(n, function (n) {
              return void 0 === t[n] && (t[n] = 0), t[n]++, e++;
            });
          }),
          (t = i.mapValues(t, function (t) {
            return t / e;
          })),
          (this._background = t),
          t
            ...
            return i.reduce(
              ...
              function (t, i, o) {
                return n.indexOf(o) >= 0
                  ? t
                  : (r && (i /= e[o]), t - i * (Math.log(i) / Math.log(2)));
              },
              0
            );
          });
      ...
      (r.prototype.conservation = function (t) {
        var e = this.ic(),
          n = this.gaps(),
          r = this;
        ...
        var o = Math.log(t) / Math.log(2),
          s = 0,
          a = i.map(e, function (t) {
            var e = o - t;
            return r.useGaps && (e *= 1 - n[s++]), e;
          });
        return a;
      }),
      (r.prototype.conservResidue = function (t) {
        var e,
        ...
        var o,
          s = this.frequency(),
          a = i.map(s, function (t, n) {
            o = i.reject(i.keys(t), function (t) {
      ...
      (r.prototype.conservResidue2 = function (t) {
        var e = this.frequency(),
          n = this.conservation(t),
          r = this.background(),
          o = i.map(e, function (t, o) {
            return i.map(
              t,
              function (t) {
                var s = i.reduce(
      ...
      (r.prototype.maxLengthCalc = function () {
        return 0 === this.seqs.length
          ? 0
          : i.max(this.seqs, function (t) {
              return t.length;
            }).length;
      }),
      (r.prototype.consensusCalc = function () {
        var t = new Array(this.maxLength());
        return (
          i.each(this.seqs, function (e) {
          ...
          (this._consensus = i.reduce(
            t,
            function (t, e) {
              var n;
              return (
                (n = i.keys(e)),
                (t += i.max(n, function (t) {
                  return e[t];
                }))
              );
            },
      ...
      (r.prototype.identityCalc = function (t) {
      ...
      i.mixin({
        mapValues: function (t, e) {
          return i.object(i.keys(t), i.map(t, e));
        },
      }),
      n(18).mixin(r.prototype),
      (t.exports = r);
  },
  function (t, e, n) {
    'use strict';
    var i = n(70);
    (t.exports = window.msa =
      function () {
        var t = function (t) {
          return i.apply(this, t);
        };
        return (t.prototype = i.prototype), new t(arguments);
      }),
      (t.exports.msa = i),
      (t.exports.model = n(43)),
      (t.exports.menu = n(58)),
      (t.exports.utils = n(34)),
      (t.exports.selection = n(8)),
      (t.exports.selcol = n(9)),
      (t.exports.view = n(3)),
      (t.exports.boneView = n(5)),
      (t.exports._ = n(1)),
      (t.exports.$ = n(7)),
      (t.exports.io = {}),
      (t.exports.io.xhr = n(21)),
      (t.exports.io.fasta = n(19)),
      (t.exports.io.clustal = n(45)),
      (t.exports.io.gff = n(37)),
      (t.exports.version = '0.2.0');
  },
  function (t, e, n) {
    'use strict';
    var i,
    ...
    t.exports = i = r.extend({
      initialize: function (t) {
        ...
        return (
          (this.msa = t.msa),
          (this.msa.g.menuconfig = new p(t.menu)),
          this.addView(
            '10_import',
            new o({ model: this.msa.seqs, g: this.msa.g, msa: this.msa })
          ),
          this.addView(
            '15_ordering',
            new u({ model: this.msa.seqs, g: this.msa.g })
          ),
          this.addView(
            '20_filter',
            new s({ model: this.msa.seqs, g: this.msa.g })
          ),
          this.addView(
            '30_selection',
            new a({ model: this.msa.seqs, g: this.msa.g })
          ),
          this.addView(
            '40_vis',
            new l({ model: this.msa.seqs, g: this.msa.g })
          ),
          this.addView(
            '50_color',
            new h({ model: this.msa.seqs, g: this.msa.g })
          ),
          this.addView(
            '70_extra',
            new c({ model: this.msa.seqs, g: this.msa.g, msa: this.msa })
          ),
          this.addView(
            '80_export',
            new d({ model: this.msa.seqs, g: this.msa.g, msa: this.msa })
          ),
          this.addView('90_help', new f({ g: this.msa.g })),
          this.msa.g.config.get('debug')
            ? this.addView('95_debug', new g({ g: this.msa.g }))
            : void 0
        );
      },
      render: function () {
  ...
  function (t, e, n) {
    'use strict';
    (t.exports.defaultmenu = n(57)), (t.exports.menubuilder = n(4));
  },
  function (t, e, n) {
    'use strict';
    var i,
  ...
  function (t, e, n) {
    ...
    t.exports = i = r.extend({
      ...
      render: function () {
        ...
        this.removeAllNodes();
        for (var e, n = this.getColorschemes(), i = 0; i < n.length; i++)
          (e = n[i]), this.addScheme(t, e);
        return (
          this.grey(t),
      ...
      addScheme: function (t, e) {
        var n = this,
          i = {},
          r = this.g.colorscheme.get('scheme');
        return (
          r === e.id && (i.backgroundColor = '#77ED80'),
          this.addNode(
            e.name,
            function () {
      ...
      render: function () {
        ...
        return (
          ...
          this.addNode('Share view (URL) ↪', function () {
            return o.shareLink(t.msa, function (t) {
          ...
          this.addNode('View in Jalview', function () {
            ...
            return 'undefined' == typeof e || null === e
              ...
              : e.indexOf('localhost')
              ? o.publishWeb(t.msa, function (e) {
                  return o.openInJalview(e, t.g.colorscheme.get('scheme'));
                })
              : o.openInJalview(e, t.g.colorscheme.get('scheme'));
          }),
          this.addNode('Export alignment (FASTA)', function () {
            return o.saveAsFile(t.msa, 'all.fasta');
          }),
          this.addNode('Export alignment (URL)', function () {
            return o.publishWeb(t.msa, function (t) {
              return window.open(t, '_blank');
            });
          }),
          this.addNode('Export selected sequences (FASTA)', function () {
            return o.saveSelection(t.msa, 'selection.fasta');
          }),
          this.addNode('Export features (GFF)', function () {
            return o.saveAnnots(t.msa, 'features.gff3');
          }),
          this.addNode('Export MSA image (PNG)', function () {
            return o.saveAsImg(t.msa, 'biojs-msa.png');
          }),
          this.el.appendChild(this.buildDOM()),
          this
        );
      ...
      render: function () {
        ...
        return (
          this.addNode('Add consensus seq', function () {
            var n = e.consensus(),
              i = new o({ seq: n, id: '0c', name: 'Consenus' });
            return (
              t.model.add(i),
              t.model.setRef(i),
          ...
          this.addNode('Increase font size', function () {
            var e = t.g.zoomer.get('columnWidth'),
              n = e + 5;
            t.g.zoomer.set('columnWidth', n), t.g.zoomer.set('rowHeight', n);
            var i = 0.7 * n;
            return (
              t.g.zoomer.set('residueFont', i),
              t.g.zoomer.set('labelFontSize', i)
            );
          }),
          this.addNode('Decrease font size', function () {
            ...
            return (
              t.g.zoomer.set('residueFont', i),
              t.g.zoomer.set('labelFontSize', i),
              t.g.zoomer.get('columnWidth') < 8
                ? t.g.zoomer.set('textVisible', !1)
                : void 0
            );
          }),
          this.addNode('Jump to a column', function () {
            var e = prompt('Column', '20');
            return 0 > e || e > t.model.getMaxLength() || isNaN(e)
      ...
      render: function () {
        ...
        return (
          ...
          this.addNode('Hide columns by gaps', function () {
            ...
            e /= 100;
            for (
              var n = t.model.getMaxLength(), i = [], r = n - 1, o = 0;
              r > 0 ? r >= o : o >= r;
              r > 0 ? o++ : o--
            ) {
              var s = 0,
          ...
          this.addNode('Hide seqs by gaps', function () {
            ...
            return t.model.each(function (t, n) {
              ...
              return r > e ? t.set('hidden', !0) : void 0;
            });
          }),
          this.addNode('Reset', function () {
            return (
              ...
              t.model.each(function (t) {
                return t.get('hidden') ? t.set('hidden', !1) : void 0;
              })
            );
          }),
          this.el.appendChild(this.buildDOM()),
  ...
  function (t, e, n) {
    ...
    t.exports = i = r.extend({
      ...
      render: function () {
        ...
        var i = '(Fasta, Clustal, GFF, Jalview features, Newick)';
        return (
          this.setName('Import'),
          this.addNode('URL', function (e) {
            ...
            return n.length > 5
              ? t.msa.u.file.importURL(n, function () {})
              : void 0;
          }),
          this.addNode('From file ' + i, function () {
            return n.click();
          }),
          this.addNode('Drag & Drop', function () {
            return alert('Yep. Just drag & drop your file ' + i);
          }),
          this.el.appendChild(this.buildDOM()),
          this
        );
  ...
  function (t, e, n) {
    ...
    t.exports = i = r.extend({
      ...
      render: function () {
        ...
        var i = this.buildDOM();
        return o.removeAllChilds(this.el), this.el.appendChild(i), this;
      },
      _addNode: function (t) {
        var e = this,
          n = t.text,
          i = {};
        return (
          n === this.order && (i.backgroundColor = '#77ED80'),
          this.addNode(
            n,
            function () {
              return (
      ...
      getComparators: function () {
        ...
        e.push({ text: 'ID ↑', comparator: 'id' }),
          ...
          e.push({ text: 'Label ↑', comparator: 'name' }),
          e.push({
            text: 'Label ↓',
            comparator: function (t, e) {
          ...
          e.push({ text: 'Seq ↑', comparator: 'seq' }),
          e.push({
            text: 'Seq ↓',
            comparator: function (t, e) {
        ...
        return (
          e.push({
            ...
            comparator: function (e, n) {
              var i = t.ident[e.id] - t.ident[n.id];
              return (
                console.log(t.ident[e.id], t.ident[n.id]),
                i > 0 ? 1 : 0 > i ? -1 : 0
              );
            },
            precode: n,
  ...
  function (t, e, n) {
    ...
    t.exports = i = r.extend({
      ...
      render: function () {
        ...
        for (var e, n = this.getVisElements(), i = 0; i < n.length; i++)
          (e = n[i]), this._addVisEl(e);
        return (
          this.addNode('Reset', function () {
            return (
    ...
    t.exports = f.extend({
      initialize: function (t) {
        ...
        if (
          ...
          (this.g = g.mixin({})),
          (this.seqs = this.g.seqs = new i(t.seqs, this.g)),
          (this.g.config = new s(t.conf)),
          (this.g['package'] = new a(this.g)),
          (this.g.selcol = new l([], { g: this.g })),
          (this.g.user = new h()),
          (this.g.vis = new u(t.vis, { model: this.seqs })),
          (this.g.visorder = new c(t.visorder)),
          (this.g.zoomer = new d(t.zoomer, { g: this.g, model: this.seqs })),
          'localhost' === window.location.hostname &&
            this.g.config.set('debug', !0),
          this._loadSeqs(t),
          (this.u = {}),
          (this.u.file = new b(this)),
          (this.u.proxy = new y({ g: this.g })),
          (this.u.tree = new x(this)),
      ...
      _loadSeqs: function (t) {
        ...
        return (
          (this.g.stats = new m(this.seqs, { useGaps: !0 })),
          (this.g.stats.alphabetSize = this.g.config.get('alphabetSize')),
          (this.g.columns = new o(t.columns, this.g.stats)),
      ...
      draw: function () {
        ...
        if (
          (this.removeViews(),
          this.addView('stage', new p({ model: this.seqs, g: this.g })),
          ...
          var i = { el: e, msa: this };
          this.menuConfig && (i.menu = this.menuConfig);
          var r = new msa.menu.defaultmenu(i);
          r.render();
        }
        return v(window).on('resize', function (e) {
          var n = function () {
      ...
      startEventBus: function () {
        ...
        return (function () {
          for (var n, i = [], r = 0; r < e.length; r++)
            (n = e[r]), i.push(t._proxyToG(n));
          return i;
        })();
      },
      _proxyToG: function (t) {
        return this.listenTo(this.g[t], 'all', function (e, n, i, r) {
          return 'change' !== e
            ? 'undefined' != typeof r && null !== r
              ? this.g.trigger(t + ':' + e, i, n, r)
              : this.g.trigger(t + ':' + e, i, n)
            : void 0;
        });
      },
      render: function () {
  ...
  function (t, e, n) {
    ...
    t.exports = i.extend({
      initialize: function (t) {
        this.g = t.g;
        var e = new o({ model: this.model, g: this.g });
        if (
          ((e.ordering = -1),
          this.addView('labelblock', e),
          this.g.vis.get('sequences'))
        ) {
          var n = new r({ model: this.model, g: this.g });
    ...
    t.exports = i = r.extend({
      ...
      initialize: function (t) {
        return (
          ...
          this.listenTo(this.model, 'change', l.debounce(this.rerender, 5)),
      ...
      rerender: function () {
        return this.g.config.get('manualRendering') ? void 0 : this.render();
      },
      render: function () {
        this._createCanvas(),
        ...
        for (
          var t = this.g.zoomer.get('boxRectWidth'),
            ...
            i = this.g.colorscheme.get('showLowerCase'),
            r = -e,
            o = this.model.length - 1,
            s = 0;
          o > 0 ? o >= s : s >= o;
          o > 0 ? s++ : s++
        ) {
          var a = this.model.at(s).get('seq'),
            l = 0;
          if (((r += e), this.model.at(s).get('hidden')))
            console.log(this.model.at(s).get('hidden')),
              (this.ctx.fillStyle = 'grey'),
              this.ctx.fillRect(0, r, a.length * t, e);
          else
            for (
              var h = a.length - 1, u = 0;
              h > 0 ? h >= u : u >= h;
              h > 0 ? u++ : u++
            ) {
              var c = a[u];
              i && (c = c.toUpperCase());
              var d = this.color.getColor(c, { pos: u });
              n.indexOf(u) >= 0 && (d = 'grey'),
                'undefined' != typeof d &&
                  null !== d &&
                  ((this.ctx.fillStyle = d), this.ctx.fillRect(l, r, t, e)),
                (l += t);
            }
        }
      ...
      _drawSelection: function () {
        if (!(this.dragStart.length > 0) || this.prolongSelection) {
          var t = this.g.zoomer.get('boxRectWidth'),
            e = this.g.zoomer.get('boxRectHeight'),
            n = e * this.model.length;
          (this.ctx.fillStyle = '#666666'), (this.ctx.globalAlpha = 0.9);
          for (
            var i = this.g.selcol.length - 1, r = 0;
            i > 0 ? i >= r : r >= i;
            i > 0 ? r++ : r++
          ) {
            var o = this.g.selcol.at(r);
            if ('column' === o.get('type'))
              this.ctx.fillRect(
                t * o.get('xStart'),
                0,
                t * (o.get('xEnd') - o.get('xStart') + 1),
                n
              );
            else if ('row' === o.get('type')) {
              var s = this.model.filter(function (t) {
                  return t.get('id') === o.get('seqId');
                })[0],
                a = this.model.indexOf(s);
              this.ctx.fillRect(0, e * a, t * s.get('seq').length, e);
            } else
              'pos' === o.get('type') &&
                ((s = this.model.filter(function (t) {
                  return t.get('id') === o.get('seqId');
                })[0]),
                (a = this.model.indexOf(s)),
                this.ctx.fillRect(
      ...
      _onmousedown: function (t) {
        ...
        return (
          ...
          a(document.body).on('mousemove.overmove', function (t) {
            return e._onmousemove(t);
          }),
          a(document.body).on('mouseup.overup', function (t) {
      ...
      _calcSelection: function (t) {
        ...
        for (
          ...
          i[n][1] < i[n][0] && (i[n] = [i[n][1], i[n][0]]),
            (i[n][0] = Math.max(i[n][0], 0));
        return i;
      },
      _endSelection: function (t) {
        if (
          (a(document.body).off('.overmove'),
          a(document.body).off('.overup'),
          0 !== this.dragStart.length)
        ) {
          for (var e = this._calcSelection(t), n = 0; 1 >= n; n++)
          ...
          for (
            var i = [], r = e[1][0];
            e[1][0] < e[1][1] ? r <= e[1][1] : r >= e[1][1];
            e[1][0] < e[1][1] ? r++ : r++
          ) {
            var o = {
              seqId: this.model.at(r).get('id'),
              xStart: e[0][0],
              xEnd: e[0][1],
            };
            i.push(new s.possel(o));
          }
          return (
            (this.dragStart = []),
    ...
    t.exports = i.extend({
      ...
      buildBtns: function () {
        ...
        return (
          ...
          o.appendChild(n),
          o.appendChild(i),
          (o.className = 'biojs_msa_searchresult_row'),
          o
        );
      },
      moveSel: function (t) {
        var e = this.selPos + t;
        return 0 > e || e >= this.sel.length
          ? -1
          ...
          this.model.each(function (t) {
            ...
            return (function () {
              for (var r, a = []; (r = s.exec(e)); ) {
                ...
                n.push(new o.possel(h)), a.push((i = Math.min(l, i)));
              }
              return a;
            })();
          }),
    ...
    t.exports = i.extend({
      ...
      draw: function () {
        if ((this.removeViews(), this.g.vis.get('overviewbox'))) {
          var t = new s({ model: this.model, g: this.g });
        ...
        var n = new a({ model: this.model, g: this.g });
        (n.ordering = this.g.visorder.get('searchBox')),
          this.addView('searchbox', n);
        var i = new r({ model: this.model, g: this.g });
        return (
          (i.ordering = this.g.visorder.get('alignmentBody')),
          this.addView('body', i)
        );
      },
      render: function () {
      ...
      rerender: function () {
        return this.g.config.get('manualRendering')
          ? void 0
      ...
      return (
        r(t, [
          ...
          },
          {
            key: 'createTile',
            value: function (t, e, n) {
              var i = (this.cache[t] = document.createElement('canvas'));
              return (
                (i.width = e),
                (i.height = n),
    ...
    (t.exports = i =
      ...
      o.extend(i.prototype, {
        _getSelection: function (t) {
          ...
          if ('undefined' != typeof r && null !== r)
            ...
            for (var l, h = 0; h < i.length; h++) {
              l = i[h];
              for (
                var u = l.get('xStart'), c = l.get('xEnd'), a = u;
                c > u ? c >= a : a >= c;
                c > u ? a++ : a++
              )
                n.push(a);
        ...
        _appendSelection: function (t) {
          var e = this,
            n = t.model.get('seq'),
            i = this._getSelection(t.model),
            o = this._getPrevNextSelection(t.model),
            s = r(o, 2),
            a = s[0],
            l = s[1];
          this.g.zoomer.get('columnWidth'), this.g.zoomer.get('rowHeight');
          if (0 !== i.length) {
            var h = 0;
            return (function () {
              for (
                var r = [], o = n.length - 1, s = 0;
                o > 0 ? o >= s : s >= o;
                o > 0 ? s++ : s++
              )
                r.push(
                  (function () {
                    if (t.hidden.indexOf(s) >= 0) return h++;
                    var n = s - h;
        ...
        _renderSelection: function (t) {
          for (
            var e = t.xZero,
              ...
              a = t.mNextSel,
              l = 0,
              h = t.model.get('seq').length - 1,
              u = i;
            (h > i ? h >= u : u >= h) && o.indexOf(u) >= 0;
            h > i ? u++ : u++
          )
            l++;
          var c = this.g.zoomer.get('columnWidth'),
            d = this.g.zoomer.get('rowHeight'),
            f = c * l + 1,
          ...
          (this.ctx.strokeStyle = '#FF0000'), (e += r * c);
          for (
            var v = 0, b = l - 1, u = 0;
            b > 0 ? b >= u : u >= b;
            b > 0 ? u++ : u--
            ...
            var x = i + u;
            g.indexOf(x) >= 0 ||
              (('undefined' != typeof s && null !== s && s.indexOf(x) >= 0) ||
                (this.ctx.moveTo(e + v, n), this.ctx.lineTo(v + c + e, n)),
              ('undefined' != typeof a && null !== a && a.indexOf(x) >= 0) ||
                (this.ctx.moveTo(v + e, d + n),
                this.ctx.lineTo(v + c + e, d + n)),
              (v += c));
          }
          return (
            this.ctx.moveTo(e, n),
            this.ctx.lineTo(e, d + n),
            this.ctx.moveTo(e + f, n),
            this.ctx.lineTo(e + f, d + n),
            this.ctx.stroke(),
        ...
        _getPrevNextSelection: function (t) {
          ...
          if ('undefined' != typeof e && null !== e)
            var i = this._getSelection(e);
          if ('undefined' != typeof n && null !== n)
            var r = this._getSelection(n);
          return [i, r];
        },
      });
  },
    ...
    t.exports = r.extend({
      ...
      initialize: function (t) {
        return (
          ...
          (this.ctx = this.el.getContext('2d')),
          (this.cache = new l(this.g)),
          (this.coordsCache = new c(this.g, this.model)),
          this.listenTo(this.g.zoomer, 'change:residueFont', function () {
            return (this.cache = new l(this.g)), this.render();
          }),
          (this.sel = new h(this.g, this.ctx)),
          this._setColor(),
          (this.throttleTime = 0),
          ...
          null != document.documentElement.style.webkitAppearance
            ? (this.throttledDraw = function () {
                ...
                if (
                  ...
                  return (
                    console.log('avgDrawTime/WebKit', e),
                    (this.throttledDraw = this.draw)
                  );
                }
              })
            : (this.throttledDraw = s.throttle(this.throttledDraw, 30)),
          this.manageEvents()
        );
      },
      throttledDraw: function () {
        ...
        if (
          ...
          var e = Math.ceil(this.throttleTime / this.throttleCounts);
          return (
            console.log('avgDrawTime', e),
            (e *= 1.2),
            (e = Math.max(20, e)),
            (this.throttledDraw = s.throttle(this.draw, e))
          );
        }
      },
      manageEvents: function () {
        ...
        return (
          ...
          this.g.config.get('registerMouseClicks') && (t.dblclick = '_onclick'),
      ...
      drawFeatures: function (t) {
        ...
        if (t.model.attributes.height > 1) {
          var i = this.ctx;
          return (
            t.model.attributes.features.each(function (r) {
              i.fillStyle = r.attributes.fillColor || 'red';
              var o = r.attributes.xEnd - r.attributes.xStart + 1,
                s = (r.attributes.row + 1) * n;
              return i.fillRect(
                r.attributes.xStart * e + t.xZero,
                s + t.yZero,
                e * o,
                n
              );
            ...
            (i.fillStyle = 'black'),
            (i.font = this.g.zoomer.get('residueFont') + 'px mono'),
            ...
            t.model.attributes.features.each(function (r) {
              ...
              return i.fillText(
                r.attributes.text,
                t.xZero + r.attributes.xStart * e + (o / 2) * e,
                t.yZero + 0.5 * n + s
              );
            })
          );
      ...
      render: function () {
        return (
          ...
          this._setColor(),
          (this.seqDrawer = new u(this.g, this.ctx, this.model, {
            width: this.el.width,
      ...
      _onmousemove: function (t, e) {
        if (0 !== this.dragStart.length) {
          var n = o.abs(t),
            i = [n[0] - this.dragStart[0], n[1] - this.dragStart[1]],
            r = this.g.zoomer.get('canvasEventScale');
          e && (r = 3);
          for (var s = 0; 1 >= s; s++) i[s] = i[s] * r;
          for (
            var a = [
                this.dragStartScroll[0] - i[0],
                this.dragStartScroll[1] - i[1],
              ],
              s = 0;
            1 >= s;
            s++
            ...
            a[s] = Math.round(a[s]);
          var l = this._checkScrolling(a);
          this.g.zoomer._checkScrolling(l, { origin: 'canvasseq' });
          for (var s = 0; 1 >= s; s++)
            l[s] !== a[s] &&
              (0 === l[s]
                ? ((this.dragStart[s] = n[s]), (this.dragStartScroll[s] = 0))
                : (this.dragStart[s] = n[s] - l[s]));
          return (
            this.throttledDraw(),
      ...
      _onmousedown: function (t) {
        ...
        return (
          ...
          a(document.body).on('mouseup.overup', function () {
            return e._cleanup();
          }),
          t.preventDefault()
        );
      ...
      _ontouchstart: function (t) {
        var e = this;
        return (
          (this.dragStart = o.abs(t.changedTouches[0])),
          (this.dragStartScroll = [
            this.g.zoomer.get('_alignmentScrollLeft'),
            this.g.zoomer.get('_alignmentScrollTop'),
          ]),
          a(document.body).on('touchmove.overtmove', function (t) {
      ...
      _onmousewinout: function (t) {
        return t.toElement === document.body.parentNode
          ? this._cleanup()
          : void 0;
      },
      _cleanup: function () {
      ...
      _touchCleanup: function (t) {
        return (
          t.changedTouches.length > 0 &&
            this._onmousemove(t.changedTouches[0], !0),
          (this.dragStart = []),
          a(document.body).off('.overtmove'),
          a(document.body).off('.overtend'),
          a(document.body).off('.overtleave'),
          a(document.body).off('.overtcancel')
        );
      },
      _onmousewheel: function (t) {
        var e = o.wheelDelta(t);
        return (
          this.g.zoomer.set(
      ...
      _getClickPos: function (t) {
        ...
        (n += this.g.columns.calcHiddenColumns(n)),
          (a += this.model.calcHiddenSeqs(a)),
          (n = Math.max(0, n)),
          (a = Math.max(0, a));
        var h = this.model.at(a).get('id');
        if (!(l > 0)) return { seqId: h, rowPos: n, evt: t };
        var u = this.model
          .at(a)
          .get('features')
          .getFeatureOnRow(l - 1, n);
        if (0 !== u.length) {
          var c = u[0];
          return (
            console.log(u[0].attributes),
            { seqId: h, feature: c, rowPos: n, evt: t }
          );
        }
      },
    ...
    var i,
      ...
      s = {
        ...
        drawSeqs: function (t, e) {
          ...
          e = e || this;
          for (
            var i = this.getStartSeq(), o = r(i, 2), s = o[0], a = o[1], l = s;
            l < this.model.length;
            l++
          ) {
            var h = this.model.at(l);
            if (!h.get('hidden')) {
              t.call(e, { model: h, yPos: a, y: l, hidden: n });
              var u = (h.attributes.height || 1) * this.rectHeight;
              if (((a += u), a > this.height)) break;
            }
          }
        },
        ...
        drawRow: function (t, e, n) {
          var i = this.g.zoomer.get('columnWidth'),
            r = Math.max(
              0,
              Math.abs(
            ...
            o = -Math.abs(-this.g.zoomer.get('_alignmentScrollLeft') % i),
            s = o - r * i,
            a = t.yPos;
          return e.call(n, {
            model: t.model,
        ...
        _getSeqForYClick: function (t) {
          for (
            var e = this.getStartSeq(),
              ...
              l = 0,
              h = i;
            a > l && h < this.model.length;

          )
            (l += this.model.at(h).attributes.height || 1), h++;
          var u = Math.max(
            0,
            Math.floor(t / this.rectHeight) -
              l +
              (this.model.at(h - 1).get('height') || 1)
          );
          return [h - 1, u];
        },
        drawSeq: function (t, e) {
          for (
            var n = t.model.get('seq'),
              ...
              a = -Math.abs(-this.g.zoomer.get('_alignmentScrollLeft') % r),
              l = { rectWidth: r, rectHeight: o, yPos: i, y: t.y },
              h = this.width,
              u = s;
            u < n.length;
            u++
            ...
            if (
              ...
              (l.c = c),
              (l.xPos = a),
              t.hidden.indexOf(u) < 0 && (e(this, l), (a += r), a > h))
            )
              break;
          }
        },
    ...
    var i = n(3),
      ...
      s = i.extend({
        ...
        render: function () {
          ...
          r.removeAllChilds(this.el);
          var e = this.model.getMaxLength(),
            n = this.g.zoomer.get('columnWidth'),
            i = 20,
            s = n * (e - this.g.columns.get('hidden').length),
            a = o.base({ height: i, width: s });
          (a.style.display = 'inline-block'), (a.style.cursor = 'pointer');
          for (
            var l = this.g.zoomer.get('stepSize'),
              h = this.g.columns.get('hidden'),
              u = 0,
              c = 0;
            e > c;

          )
            if (h.indexOf(c) >= 0) c += l;
            else {
              s = n * l;
              for (
                var d = 0, f = l - 1, g = 0;
              ...
              (m.rowPos = c), a.appendChild(m), (u += s), (c += l);
            }
          return this.el.appendChild(a), this;
        },
        _onclick: function (t) {
          var e = this,
            n = t.target.rowPos,
            i = this.g.zoomer.get('stepSize');
          return (function () {
            for (
              var r = [], o = i - 1, s = 0;
              o > 0 ? o >= s : s >= o;
              ...
              r.push(e.g.trigger('bar:click', { rowPos: n + s, evt: t }));
            return r;
          })();
        },
        manageEvents: function () {
        ...
        _onclick: function (t) {
          ...
          return (function () {
            for (
              ...
              r.push(e.g.trigger('gap:click', { rowPos: n + s, evt: t }));
            return r;
          })();
        },
        manageEvents: function () {
    ...
    t.exports = i.extend({
      ...
      draw: function () {
        if (
          ...
          var t = new r({ model: this.model, g: this.g });
    ...
    t.exports = i = o.extend({
      ...
      labelDOM: function () {
        ...
        if (
          ...
          this.g.vis.get('labelCheckbox') && t.appendChild(this.addEl('.', 10)),
          this.g.vis.get('labelId') &&
            t.appendChild(this.addEl('ID', this.g.zoomer.get('labelIdLength'))),
          this.g.vis.get('labelPartition') &&
    ...
    var i = n(3),
      ...
      a = i.extend({
        ...
        render: function () {
          ...
          for (
            var t = document.createElement('span'),
              e = 0,
              n = this.g.zoomer.get('columnWidth'),
              i = this.model.getMaxLength(),
              o = this.g.zoomer.get('stepSize'),
              s = this.g.columns.get('hidden');
            i > e;

          )
            if (s.indexOf(e) >= 0) this.markerHidden(a, e, o), (e += o);
            else {
              var a = document.createElement('span');
              (a.style.width = n * o + 'px'),
                (a.style.display = 'inline-block'),
                (e + 1) % this.g.zoomer.get('markerStepSize') === 0
                  ? (a.textContent = e + 1)
                  : (a.textContent = '.'),
                (a.rowPos = e),
                (e += o),
        ...
        markerHidden: function (t, e, n) {
          for (
            var i = this,
              r = this.g.columns.get('hidden').slice(0),
              a = Math.max(0, e - n),
              l = !0,
              h = a;
            e > a ? e >= h : h >= e;
          ...
          if (!l) {
            for (
              var u = this.model.getMaxLength(), c = 0, d = -1, e = e;
              (u > e ? u >= e : e >= u) &&
              (d >= 0 || (d = r.indexOf(e)), r.indexOf(e) >= 0);
              u > e ? e++ : e++
            )
              c++;
            var f = o.base({ height: 10, width: 10 });
            ...
            return (
              s(g).on('click', function (t) {
                return r.splice(d, c), i.g.columns.set('hidden', r);
              }),
              f.appendChild(g),
              t.appendChild(f),
              f
    ...
    t.exports = o.extend({
      ...
      draw: function () {
        ...
        if (this.g.vis.get('markers')) {
          var e = new i({ model: this.model, g: this.g });
          (e.ordering = -10), this.addView('marker', e);
        }
        if (this.g.vis.get('seqlogo')) {
          var n = new s({ model: this.model, g: this.g });
          (n.ordering = -30), this.addView('seqlogo', n);
        }
        if (this.g.vis.get('gapHeader')) {
          var o = new a({ model: this.model, g: this.g });
          return (o.ordering = -25), this.addView('gapview', o);
        }
      },
      render: function () {
        return (
      ...
      _adjustScrollingLeft: function (t, e, n) {
        if (
          null == ('undefined' != typeof n && null !== n ? n.origin : void 0) ||
          'header' !== n.origin
        ) {
          var i = this.g.zoomer.get('_alignmentScrollLeft');
          return (this.blockEvents = !0), (this.el.scrollLeft = i);
        }
      },
      _setSpacer: function () {
  ...
  function (t, e, n) {
    ...
    t.exports = r.extend({
      ...
      draw: function () {
        o.removeAllChilds(this.el), console.log('redraw seqlogo');
  ...
  function (t, e, n) {
    ...
    t.exports = r.extend({
      ...
      draw: function () {
        this.removeViews(), console.log('redraw columns', this.model.length);
        for (var t = 0; t < this.model.length; t++)
          if (!this.model.at(t).get('hidden')) {
            var e = new i({ model: this.model.at(t), g: this.g });
  ...
  function (t, e, n) {
    ...
    t.exports = i.extend({
      ...
      draw: function () {
        if (
          ...
          this.g.vis.get('labels') &&
            this.addView('labels', new r({ model: this.model, g: this.g })),
          this.g.vis.get('metacell'))
        ) {
          var t = new o({ model: this.model, g: this.g });
      ...
      setSelection: function () {
        var t = this.g.selcol.getSelForRow(this.model.id);
        return t.length > 0
      ...
      o = i.extend({
        ...
        render: function () {
          ...
          if (this.g.vis.get('labelPartition')) {
            ...
            (i.style.width = this.g.zoomer.get('labelPartLength') + 'px'),
              (i.textContent = this.model.get('partition')),
  ...
  function (t, e, n) {
    ...
    t.exports = i = r.extend({
      ...
      render: function () {
        a.removeAllChilds(this.el), (this.el.style.display = 'inline-block');
        ...
        if (this.g.vis.get('metaIdentity')) {
          var r = this.g.stats.identity()[this.model.id],
            h = document.createElement('span');
          this.model.get('ref') && this.g.config.get('hasRef')
            ? (h.textContent = 'ref.')
            : 'undefined' != typeof r &&
              null !== r &&
              (h.textContent = r.toFixed(2)),
            (h.style.display = 'inline-block'),
            (h.style.width = 40),
            this.el.appendChild(h);
        }
        if (this.g.vis.get('metaLinks') && this.model.attributes.ids) {
          var u = l.buildLinks(this.model.attributes.ids);
          if (s.keys(u).length > 0) {
            var c = new o({ name: '↗' });
            console.log(s.keys(u)),
              s.each(u, function (t, e) {
                return c.addNode(e, function (e) {
                  return window.open(t);
                });
              });
            var d = c.buildDOM();
            return (d.style.cursor = 'pointer'), this.el.appendChild(d);
          }
        }
      },
      _onclick: function (t) {
    ...
    !(function () {
      ...
      i = {
        ...
        off: function (t, e, n) {
          ...
          for (
            s = t ? [t] : l.keys(this._events), a = 0, h = s.length;
            h > a;
            a++
          )
      ...
      var h = /\s+/,
        u = function (t, e, n, i) {
          ...
          if (h.test(n)) {
            for (var o = n.split(h), s = 0, a = o.length; a > s; s++)
      ...
      l.each(d, function (t, e) {
        i[e] = function (e, n, i) {
          var r = this._listeners || (this._listeners = {}),
            o = e._listenerId || (e._listenerId = l.uniqueId('l'));
          return (
            (r[o] = e),
  ...
  function (t, e, n) {
    var i = n(11),
      ...
      u = { add: !0, remove: !0, merge: !0 },
      c = { add: !0, remove: !1 };
    o.extend(h.prototype, i, {
      model: s,
      initialize: function () {},
      toJSON: function (t) {
      ...
      add: function (t, e) {
        return this.set(t, o.extend({ merge: !1 }, e, c));
      },
      remove: function (t, e) {
        var n = !o.isArray(t);
        (t = n ? [t] : o.clone(t)), e || (e = {});
        for (var i = 0, r = t.length; r > i; i++) {
          var s = (t[i] = this.get(t[i]));
          if (s) {
            ...
            this.models.splice(l, 1),
              this.length--,
              e.silent || ((e.index = l), s.trigger('remove', s, this, e)),
      ...
      set: function (t, e) {
        (e = o.defaults({}, e, u)), e.parse && (t = this.parse(t, e));
        var n = !o.isArray(t);
        t = n ? (t ? [t] : []) : t.slice();
        for (
          var i,
            ...
            l,
            h = e.at,
            c = this.comparator && null == h && e.sort !== !1,
            d = o.isString(this.comparator) ? this.comparator : null,
            f = [],
            g = [],
            p = {},
            m = e.add,
          ...
          if (((s = t[y]), (a = this.get(s))))
            b && (p[a.cid] = !0),
              v &&
                ...
                a.set(s, e),
                c && !l && a.hasChanged(d) && (l = !0)),
              (t[y] = a);
          else if (m) {
            if (((r = t[y] = this._prepareModel(s, e)), !r)) continue;
            f.push(r), this._addReference(r, e);
          }
          (r = a || r),
            r &&
              ((i = this.modelId(r.attributes)),
              !x || (!r.isNew() && p[i]) || x.push(r),
              (p[i] = !0));
        }
        if (b) {
          for (var y = 0, w = this.length; w > y; y++)
            p[(r = this.models[y]).cid] || g.push(r);
          g.length && this.remove(g, e);
        }
        if (f.length || (x && x.length))
          if ((c && (l = !0), (this.length += f.length), null != h))
            for (var y = 0, w = f.length; w > y; y++)
              this.models.splice(h + y, 0, f[y]);
          else {
            x && (this.models.length = 0);
            for (var _ = x || f, y = 0, w = _.length; w > y; y++)
              this.models.push(_[y]);
          }
        if ((l && this.sort({ silent: !0 }), !e.silent)) {
          for (
            var S = null != h ? o.clone(e) : e, y = 0, w = f.length;
            w > y;
            y++
          )
            null != h && (S.index = h + y),
              (r = f[y]).trigger('add', r, this, S);
    ...
    o.each(f, function (t) {
      o[t] &&
        (h.prototype[t] = function (e, n) {
          var i = o.isFunction(e)
            ? e
            : function (t) {
                return t.get(e);
              };
          return o[t](this.models, i, n);
        });
    }),
      (h.extend = r),
      (t.exports = h);
    ...
    (i.readHeader = function (t) {
      for (var e, n = {}, r = 0, o = []; r < t.length; r++) {
        ...
        if (2 === a.length)
          ...
          var h = i.parseLine(a);
          e && (h.attributes.Parent = e), o.push(h);
        }
      }
  ...
  function (t, e, n) {
    ...
    function a(t) {
      ...
      function n() {
        ...
        if (
          (h.response
            ? (t = h.response)
            : ('text' !== h.responseType && h.responseType) ||
              (t = h.responseText || h.responseXML),
          y)
        )
          try {
            t = JSON.parse(t);
          ...
          0 !== e
            ? ((i = {
              ...
              h.getAllResponseHeaders &&
                (i.headers = d(h.getAllResponseHeaders())))
      ...
      var c,
        ...
        g,
        p = (h.url = t.uri || t.url),
        m = (h.method = t.method || 'GET'),
        v = t.body || t.data || null,
        b = (h.headers = t.headers || {}),
        x = !!t.sync,
        y = !1;
      if (
        ('json' in t &&
        ...
        (h.ontimeout = i),
        h.open(m, p, !x, t.username, t.password),
        x || (h.withCredentials = !!t.withCredentials),
        !x &&
          t.timeout > 0 &&
        ...
        for (c in b) b.hasOwnProperty(c) && h.setRequestHeader(c, b[c]);
    ...
    var h = n(50),
      ...
      f = n(139);
    (t.exports = s),
      (s.XMLHttpRequest = h.XMLHttpRequest || l),
      (s.XDomainRequest =
        'withCredentials' in new s.XMLHttpRequest()
          ? s.XMLHttpRequest
          : h.XDomainRequest),
      i(['get', 'put', 'post', 'patch', 'head', 'delete'], function (t) {
        s['delete' === t ? 'del' : t] = function (e, n, i) {
          return (n = o(e, n, i)), (n.method = t.toUpperCase()), a(n);
        };
      });
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n) {
      t
        ...
        .on('click', function (t) {
          t.preventDefault(), i('.logo_settings').toggle();
        }),
        ...
        i(document).on(t.attr('id') + '.scrolledTo', function (t, n, i, r) {
          e.render({ target: n });
        }),
  ...
  function (t, e, n) {
    ...
    t.exports = s.extend({
      ...
      loadDefault: function (t) {
        (this.data = t.data),
          ...
          t.colors
            ...
            : 'aa' === this.alphabet
            ? ((this.aa_colors = n(100)), this.changeColors(this.aa_colors))
            : ((this.dna_colors = n(101)), this.changeColors(this.dna_colors));
      },
      initialize: function (t) {
        if (!i())
        ...
        l(this.$el, this, this.logo_graphic);
      },
      initDivs: function () {
        var t = c('div');
        (t.className = 'logo_graphic'), (this.logo_graphic = u(t));
        var e = c('div');
        if (
      ...
      changeColors: function (t) {
        ...
        e && (this.colorscheme = 'dynamic'), this.buildAlphabet();
      },
      ...
      changeZoom: function (t) {
        ...
        if (
          ...
          if (t.column) {
            ...
            this.scrollme.scroller.scrollTo(i - t.offset);
          } else {
            var r = this.currentColumn();
            (this.zoom = e),
              this.render({ zoom: this.zoom }),
              this.scrollme.reflow(),
              this.scrollToColumn(r);
          }
        return this.zoom;
      },
      columnFromCoordinates: function (t) {
        var e = Math.ceil(t / (this.column_width * this.zoom));
        return e;
      },
      ...
      scrollToColumn: function (t, e) {
        var n = this.logo_container.width() / 2,
          i = this.coordinatesFromColumn(t);
        this.scrollme.scroller.scrollTo(i - n, 0, e);
      },
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e) {
      var n = i(
        ...
        r = i('<div class="logo_settings"></div>');
      if (
        (r.append('<span class="close">x</span>'),
      ...
      if (
        ...
        var u = null,
          ...
          d = '',
          f = '';
        'default' === t.colorscheme ? (u = 'checked') : (c = 'checked'),
          e.help &&
            ((d =
      ...
      var y = i('<div class="logo_controls"></div>');
      return (
        t.zoom_enabled &&
          y.append(
  ...
  function (t, e) {
    t.exports = function (t, e) {
      (e = e || {}),
        ...
        (this.draw = function (t, e, n, i, r, o) {
          var s = e / this.height,
            a = n / this.width,
            l = t.font;
          t.transform(a, 0, 0, s, i, r),
    ...
    t.exports = function (t) {
      if (this.data) {
        ...
        if (
          ...
          0.1 >= e ? (e = 0.1) : e >= 1 && (e = 1),
          (this.zoom = e),
          (l = this.end || this.data.heightArr.length),
          (h = this.start || 1),
          (l = l > this.data.heightArr.length ? this.data.heightArr.length : l),
          (l = h > l ? h : l),
          (h = h > l ? l : h),
          (h = h > 1 ? h : 1),
          (this.y = this.height - 20),
          (this.max_width = this.column_width * (l - h + 1)),
          s > this.max_width && ((e = 1), (this.zoom_enabled = !1)),
          (this.zoom = e),
          (this.zoomed_column = this.column_width * e),
          (this.total_width = this.zoomed_column * (l - h + 1)),
          1 > e)
        )
          for (
            ;
        ...
        var c = Math.ceil(this.total_width / this.canvas_width);
        for (
          ...
          var d = this.columns_per_canvas * u + h,
            f = d + this.columns_per_canvas - 1;
          f > l && (f = l);
          ...
          if (m + m / 2 > n && n > p - p / 2)
            if (
              ((this.canvases[u] = i(this.dom_element, this.height, g, u, a)),
              (this.contexts[u] = this.canvases[u].getContext('2d')),
              this.contexts[u].setTransform(1, 0, 0, 1, 0, 0),
              this.contexts[u].clearRect(0, 0, g, this.height),
              (this.contexts[u].fillStyle = '#ffffff'),
              this.contexts[u].fillRect(0, 0, m, this.height),
              this.zoomed_column > 12)
            ) {
              var v = parseInt(10 * e, 10);
              (v = v > 10 ? 10 : v),
                this.debug && o.call(this, d, f, u, 1),
                r.call(this, d, f, u, v);
            } else o.call(this, d, f, u);
        }
        !this.scrollme &&
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, a) {
      var l = 0,
        ...
        u = null,
        c = 0,
        d = Math.abs(this.data.max_height),
        f = Math.abs(this.data.min_height_obs),
        g = d + f,
      ...
      for (c = t; e >= c; c++) {
        if (this.data.mmline && 1 === this.data.mmline[c - 1])
          ...
          var b = this.data.heightArr[c - 1],
            x = 0,
            y = (b.length, 0);
          for (var y in b)
            if (((values = [y, b[y]]), values[1] > 0.01)) {
              var w = parseFloat(values[1]) / this.data.max_height,
                _ = l,
                S = (this.info_content_height - 2) * w,
                C = this.info_content_height - 2 - x - S,
                k = null;
              (k =
                'dynamic' === this.colorscheme
                  ? this.colors.getColor(values[0], { pos: c - 1 })
                  : 'consensus' === this.colorscheme
                  ? this.cmap[c - 1][values[0]] || '#7a7a7a'
                  : this.colors[values[0]]),
                a
                  ? ((this.contexts[n].strokeStyle = k),
                    this.contexts[n].strokeRect(_, C, this.zoomed_column, S))
                  : ((this.contexts[n].fillStyle = k),
                    this.contexts[n].fillRect(_, C, this.zoomed_column, S)),
                (x += S);
            }
        }
        this.zoom < 0.2 ? (v = 20) : this.zoom < 0.3 && (v = 10),
          this.options.positionMarker &&
            ...
            (this.options.show_probs &&
              o(
                this.contexts[n],
                l + this.zoomed_column,
                this.height - 30,
                parseFloat(this.height),
                '#dddddd'
              ),
            o(this.contexts[n], l + this.zoomed_column, 0, 5),
            (u = this.display_ali_map ? this.data.ali_map[c - 1] : h),
            s(this.contexts[n], l - 2, 10, this.zoomed_column, u, 10, !0)),
          this.options.show_probs &&
            i(
              this.contexts[n],
              l,
              this.height - 42,
              this.zoomed_column,
              this.data.insert_probs[c - 1],
              this.data.insert_lengths[c - 1],
              this.data.delete_probs[c - 1],
              this.show_inserts
            ),
          this.options.show_probs &&
            (this.show_inserts
              ? r(this.contexts[n], this.height - 45, this.total_width)
              : r(this.contexts[n], this.height - 15, this.total_width)),
          this.options.border && r(this.contexts[n], 0, this.total_width),
          (l += this.zoomed_column),
          h++;
      }
    };
  ...
  function (t, e, n) {
    ...
    function r(t, e, n, i, r, o, s, a) {
      (t.font = r + 'px Arial'),
        ...
        (t.textAlign = 'center'),
        (t.fillStyle = a),
        t.fillText(i, e + o / 2, n);
    }
    function o(t, e) {
      var n = e.ralign ? e.x + t.zoomed_column : e.x,
        i = e.ralign ? e.x + 2 : e.x;
      h(t.contexts[e.context_num], n, t.height - 30, -30 - t.height, '#dddddd'),
        h(t.contexts[e.context_num], n, 0, 5),
        u(
    ...
    t.exports = function (t, e, n, r) {
      var u = 0,
        ...
        b = Math.round((this.info_content_height * v) / 100),
        x = this.info_content_height - b;
      b / this.info_content_height, x / this.info_content_height;
      for (e + 3 <= this.end && (e += 3), f = t; e >= f; f++) {
        if (this.data.mmline && 1 === this.data.mmline[f - 1])
          (this.contexts[n].fillStyle = '#cccccc'),
            this.contexts[n].fillRect(
              u,
              10,
          ...
          if (y) {
            ...
            for (var S in y) {
              var k = y[S],
                E = [S, k];
              if (
                ((x_pos = u + this.zoomed_column / 2),
                (letter_height = null),
                E[1] > 0.01)
              ) {
                letter_height = parseFloat(E[1]) / this.data.max_height;
                var z = this.info_content_height - 2 - _,
                  T = (this.info_content_height - 2) * letter_height;
                (w[S] = [T, this.zoomed_column, x_pos, z]), (_ += T);
              }
            }
            for (var S in y)
              w[S] &&
                ...
                ((C =
                  'dynamic' === this.colorscheme
                    ? this.colors.getColor(S, { pos: f - 1 })
                    : 'consensus' === this.colorscheme
                    ? this.cmap[f - 1][S] || '#7a7a7a'
                    : null),
                this.letters[S].draw(
                  this.contexts[n],
                  w[S][0],
        ...
        (d = this.display_ali_map ? this.data.ali_map[f - 1] : c),
          this.options.show_divider &&
            (this.zoom < 0.7
              ? f % this.options.divider_step === 0 &&
                o(this, {
                  context_num: n,
                  x: u,
                  fontsize: 10,
              ...
              : o(this, { context_num: n, x: u, fontsize: r, column_num: d })),
          this.options.show_probs &&
            (i(
              this.contexts[n],
              u,
              this.height,
              this.zoomed_column,
              this.data.delete_probs[f - 1],
              r,
              this.show_inserts
            ),
            h(this.contexts[n], u, this.height - 15, 5),
            this.show_inserts &&
              (s(
                this.contexts[n],
                u,
              ...
              a(
                ...
                this.height - 5,
                this.zoomed_column,
                this.data.insert_lengths[f - 1],
                r
              ),
              h(this.contexts[n], u, this.height - 45, 5),
              h(this.contexts[n], u, this.height - 30, 5))),
          (u += this.zoomed_column),
          c++;
      }
      this.options.show_probs &&
        (this.show_inserts &&
          (l(this.contexts[n], this.height - 30, this.total_width),
          l(this.contexts[n], this.height - 45, this.total_width)),
        l(this.contexts[n], this.height - 15, this.total_width)),
        this.options.border && l(this.contexts[n], 0, this.total_width);
    };
  },
  function (t, e) {
      ...
      s =
        ...
        function (t) {
          ...
          for (
            ...
            s[a] = e.charCodeAt(a);
          return (
            (l = t.split(',')[0].split(':')[1].split(';')[0]),
            i
              ? new Blob([r ? s : n], { type: l })
              : ((h = new o()), h.append(n), h.getBlob(l))
          );
        };
    window.HTMLCanvasElement &&
      !n.toBlob &&
      (n.mozGetAsFile
        ? (n.toBlob = function (t, e, i) {
            t(
              i && n.toDataURL && s
                ? s(this.toDataURL(e, i))
            ...
            var e = t.document,
              ...
              g = function (e, l) {
                var d,
                  ...
                  w = function () {
                    (b || !d) && (d = x(e)),
                      g ? (g.location.href = d) : window.open(d, '_blank'),
                      (m.readyState = m.DONE),
                      y();
                  },
                  _ = function (t) {
  ...
  function (t, e, n) {
    ...
    function r(t, e, n) {
      for (var i = 0, r = t.length; r > i; i++)
        h.call(t, i) && e.call(n, t[i], i, t);
    }
    function o(t, e, n) {
      for (var i = 0, r = t.length; r > i; i++) e.call(n, t.charAt(i), i, t);
    }
    function s(t, e, n) {
      for (var i in t) h.call(t, i) && e.call(n, t[i], i, t);
    }
    var a = n(51);
    t.exports = i;
        ...
        o.extend({
          ...
          addNode: function (t, e, n) {
            ...
            null != n && (i = n.style),
              ...
              this._nodes.push({ label: t, callback: e, style: i });
          },
          getNode: function (t) {
            var e = void 0;
            return (
          ...
          modifyNode: function (t, e, n) {
            ...
            (i.callback = e || i.callback),
              (n = n || {}),
              (i.style = n.style || i.style);
          },
          ...
          _buildM: function (t) {
            ...
            (c.className = 'smenu-dropdown smenu-dropdown-tip'),
          ...
          _showMenu: function (t, e, n) {
            ...
            (e.style.display = 'block'),
              ...
              (e.style.top = i.top + n.offsetHeight + 'px');
          },
        }));
  },
  function (t, e) {
  ...
  function (t, e, n) {
    ...
    (t.exports = Colors =
      function (t) {
        (this.maps = i(w)), (this.dyn = i(S)), (this.opt = t);
      }),
      (Colors.getScheme = function (t) {
        return w[t];
      }),
      (Colors.prototype.getScheme = function (t) {
        var e = this.maps[t];
        return void 0 === e && ((e = {}), void 0 != this.dyn[t])
          ? new s(this.dyn[t], this.opt)
          : new o(e);
      }),
      (Colors.prototype.addStaticScheme = function (t, e) {
        this.maps[t] = e;
      }),
      (Colors.prototype.addDynScheme = function (t, e) {
        this.dyn[t] = e;
      });
  },
  function (t, e) {
  ...
  function (t, e) {
    ...
    (t.exports.stat = n), (t.exports.dyn = i);
  },
  function (t, e) {
    t.exports = {
      A: '#5858a7',
  ...
  function (t, e) {
    function n() {
      (h = !1), s.length ? (l = s.concat(l)) : (u = -1), l.length && i();
    }
    function i() {
      if (!h) {
        var t = setTimeout(n);
    ...
    (a.nextTick = function (t) {
      ...
      l.push(new r(t, e)), 1 !== l.length || h || setTimeout(i, 0);
    }),
  ...
  function (t, e, n) {
    function i(t, e) {
      for (var n = 0; n < t.length; n++) {
        ...
        if (r) {
          ...
          for (; o < i.parts.length; o++) r.parts.push(h(i.parts[o], e));
        } else {
          for (var s = [], o = 0; o < i.parts.length; o++)
            s.push(h(i.parts[o], e));
    ...
    function r(t) {
      for (var e = [], n = {}, i = 0; i < t.length; i++) {
        ...
        n[o] ? n[o].parts.push(h) : e.push((n[o] = { id: o, parts: [h] }));
      }
      return e;
    }
    function o(t, e) {
  ...
  function (t, e, n) {
    ...
    (function (r, o, s) {
      ...
      !(function (r) {
        var a,
          l = (function () {
            ...
            if (i) {
              ...
              return (
                new i(n).observe(l, { characterData: !0 }),
                function (t) {
                  e(t) && (l.data = a *= -1);
                }
              );
            ...
            if (r.postMessage) {
              ...
              if (r.attachEvent) {
                ...
                r.attachEvent('onmessage', u),
                  r.postMessage('__checkAsync', '*'),
                  r.detachEvent('onmessage', u);
              }
              if (h) {
                ...
                return (
                  r.addEventListener
                    ? r.addEventListener('message', d, !0)
            ...
            if ('onreadystatechange' in f.createElement('script')) {
              var g = function () {
                ...
                (t.onreadystatechange = function () {
                  ...
                  (f.documentElement || f.body).appendChild(t);
              };
              return function (t) {
                e(t) && g();
              };
          ...
          g = function (t) {
            for (var e = [], n = 0, i = t.length; i > n; ) e.push(n++);
            return e;
          },
          p =
            Object.keys ||
        ...
        var x = { PENDING: 0, RESOLVED: 1, FULFILLED: 2, REJECTED: 3 },
          y = function (t) {
            if (
              ((this._value = a),
              (this._status = x.PENDING),
        ...
        y.prototype = {
          ...
          isResolved: function () {
            return this._status !== x.PENDING;
          },
          isFulfilled: function () {
            return this._status === x.FULFILLED;
          },
          isRejected: function () {
            return this._status === x.REJECTED;
          },
          then: function (t, e, n, i) {
            var r = new b();
            return this._addCallbacks(r, t, e, n, i), r.promise();
          },
          catch: function (t, e) {
            return this.then(a, t, e);
          },
          fail: function (t, e) {
            return this.then(a, t, e);
          },
          ...
          progress: function (t, e) {
            return this.then(a, a, t, e);
          },
          spread: function (t, e, n) {
            return this.then(
              function (e) {
          ...
          done: function (t, e, n, i) {
            this.then(t, e, n, i).fail(h);
          },
          delay: function (t) {
            var e,
          ...
          timeout: function (t) {
            var e = new b(),
              n = setTimeout(function () {
                e.reject(new S.TimedOutError('timed out'));
              }, t);
            return (
              this.then(
                function (t) {
          ...
          _vow: !0,
          _resolve: function (t) {
            if (!(this._status > x.RESOLVED)) {
              if (t === this)
                return void this._reject(
                  TypeError("Can't resolve promise with itself")
                );
              if (((this._status = x.RESOLVED), t && t._vow))
                return void (t.isFulfilled()
                  ? this._fulfill(t.valueOf())
                  : t.isRejected()
                  ? this._reject(t.valueOf())
                  : t.then(this._fulfill, this._reject, this._notify, this));
              if (c(t) || u(t)) {
                var e;
                try {
                  e = t.then;
          ...
          _addCallbacks: function (t, e, n, i, r) {
            n && !u(n) ? ((r = n), (n = a)) : i && !u(i) && ((r = i), (i = a));
            var o;
            this.isRejected() ||
              ((o = { defer: t, fn: u(e) ? e : a, ctx: r }),
              this.isFulfilled()
                ? this._callCallbacks([o], this._value)
                : this._fulfilledCallbacks.push(o)),
              this.isFulfilled() ||
                ((o = { defer: t, fn: n, ctx: r }),
                this.isRejected()
                  ? this._callCallbacks([o], this._value)
                  : this._rejectedCallbacks.push(o)),
              this._status <= x.RESOLVED &&
                this._progressCallbacks.push({ defer: t, fn: i, ctx: r });
          },
          _callCallbacks: function (t, e) {
            ...
            if (n) {
              var i = this.isResolved(),
                ...
                o = this.isRejected();
              l(function () {
                for (var s, a, l, h = 0; n > h; )
                  if (((s = t[h++]), (a = s.defer), (l = s.fn))) {
                    var u,
                      c = s.ctx;
                    try {
                      u = c ? l.call(c, e) : l(e);
                    ...
                    i ? a.resolve(u) : a.notify(u);
                  } else r ? a.resolve(e) : o ? a.reject(e) : a.notify(e);
              });
            }
          },
        };
        ...
        for (var _ in w) w.hasOwnProperty(_) && (y[_] = w[_]);
        var S = {
            Deferred: b,
            Promise: y,
            defer: function () {
            ...
            when: function (t, e, n, i, r) {
              return S.cast(t).then(e, n, i, r);
            },
            fail: function (t, e, n) {
              return S.when(t, a, e, n);
            },
            always: function (t, e, n) {
              return S.when(t).always(e, n);
            },
            progress: function (t, e, n) {
              return S.when(t).progress(e, n);
            },
            spread: function (t, e, n, i) {
              return S.when(t).spread(e, n, i);
            },
            done: function (t, e, n, i, r) {
              S.when(t).done(e, n, i, r);
            },
            isPromise: function (t) {
              return c(t) && u(t.then);
            },
            cast: function (t) {
              return t && t._vow ? t : S.resolve(t);
            },
            valueOf: function (t) {
              return t && u(t.valueOf) ? t.valueOf() : t;
            },
            isFulfilled: function (t) {
              return t && u(t.isFulfilled) ? t.isFulfilled() : !0;
            },
            isRejected: function (t) {
              return t && u(t.isRejected) ? t.isRejected() : !1;
            },
            isResolved: function (t) {
              return t && u(t.isResolved) ? t.isResolved() : !0;
            },
            resolve: function (t) {
              var e = S.defer();
            ...
            invoke: function (t, e) {
              ...
              if (i) {
                n = Array(i);
                for (var o = 0; i > o; ) n[o++] = arguments[o];
              }
              try {
                return S.resolve(n ? t.apply(r, n) : t.call(r));
              } catch (s) {
                return S.reject(s);
              }
            },
            ...
            allResolved: function (t) {
              ...
              return S._forEach(t, s, s, e.notify, e, i), e.promise();
            },
            allPatiently: function (t) {
              return S.allResolved(t).then(function () {
                var e,
                  n,
                  i,
                  r,
                ...
                for (; a > l; )
                  (i = s[l++]),
                    ...
                    S.isRejected(r)
                      ? (e || (e = o ? [] : {}),
                        o ? e.push(r.valueOf()) : (e[i] = r.valueOf()))
                      : e || ((n || (n = o ? [] : {}))[i] = S.valueOf(r));
                if (e) throw e;
                return n;
              });
            },
            ...
            anyResolved: function (t) {
              var e = new b(),
                n = t.length;
              return n
                ? (S._forEach(t, e.resolve, e.reject, e.notify, e), e.promise())
                : (e.reject(Error()), e.promise());
            },
            delay: function (t, e) {
              return S.resolve(t).delay(e);
            },
            timeout: function (t, e) {
              return S.resolve(t).timeout(e);
            },
            _forEach: function (t, e, n, i, r, o) {
              for (var s = o ? o.length : t.length, a = 0; s > a; )
                S.when(t[o ? o[a] : a], v(e, a), n, i, r), ++a;
            },
